"""Schemas describing the structured output for the form value generator agent."""
...
class FormValueGeneratorOutput(BaseModel):
    """Top-level structured response returned by the value generator."""

    actions: List[GeneratedAction] = Field(
        default_factory=list,
        description="Ordered list of actions required to complete the form.",
    )
